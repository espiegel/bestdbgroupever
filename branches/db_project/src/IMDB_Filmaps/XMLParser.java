...
public class XMLParser extends DefaultHandler {
	 ...
	 */
	public XMLParser(Connection connect, boolean isIMDB, String filePath,int limit) {
	...
	public int uploadMovieLocations() throws SQLException {
		Uploader uploader = new Uploader(connect);
		return uploader.uploadLocations(myMovies);
	}
