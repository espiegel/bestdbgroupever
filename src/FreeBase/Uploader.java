...
public class Uploader {
	 ...
	 */
	public void uploadFreeBaseFilms(int limit) throws IOException, SQLException, FreebaseServiceException {
		insert(false,limit);
	}
	 ...
	 * @throws FreebaseServiceException 
	 */
	public void uploadFreeBaseTVShows(int limit) throws IOException, SQLException, FreebaseServiceException {
		insert(true,limit);
	}
	 ...
	 * @throws FreebaseServiceException 
	 */
	private void insert(boolean tv,int limit) throws IOException, SQLException, FreebaseServiceException {
		System.out
	...
	private String insertMedia(ReadService readService, boolean tv,
			String insert2, String mql_path) throws SQLException, IOException, FreebaseServiceException {
		...
		try {
			...
			com.narphorium.freebase.results.ResultSet results = readService
					.read(query, "");
